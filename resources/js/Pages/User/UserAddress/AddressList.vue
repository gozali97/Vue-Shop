        ...
        >
            ...
            <form @submit.prevent="isEditItem ? updateAddress() : AddAddress()">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" v-model="address2" name="form_address2" id="form_address2" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Address 2" required>
                        </div>
                        <div class="mb-6">
                            <label for="form_address2" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">City</label>
                            <input type="text" v-model="address2" name="form_address2" id="form_address2" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Address 2" required>
                        </div>
                        <div class="mb-6">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tr v-for="(item, index) in address.data" :key="item.id" class="border-b dark:border-gray-700">
                            ...
                            <th scope="row" class="px-4 py-3 font-medium dark:text-gray-200 text-gray-900 whitespace-nowrap">{{item.address1}}</th>
